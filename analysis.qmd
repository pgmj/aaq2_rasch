...
Data from [@langer2024]. More comments on that paper comint later.
...
are oddly normally distributed. Response category 2 is consistently
...
```{r}
hist(df.viz$latentscore, breaks = 20, main = "Histogram of Rasch estimated latent scores", col = "lightpink")
```
